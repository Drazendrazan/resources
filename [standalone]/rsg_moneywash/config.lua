...
Config.CutPercentage = 80 -- percentage of cash player gets when washed : example 10 = 10% / 50 = 50% / 100 = 100%  / 200 = 200% (double)
...
Config.DistanceSpawn = 30.0 -- Distance before spawning/despawning the ped. (GTA Units.)
