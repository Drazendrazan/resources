...
Config.OpenMenu = 'O' -- https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
...
-- Config.MinimumStress = 5000 -- Minimum Stress Level For Screen Shaking
