...
Config.GrowthTimer = 60000 -- 60000 = every 1 min / 300000 = every 5 min / 600000 = every 10 min / testing 1000 = 1 seconds
...
Config.YieldRewards = {
    {type = "weed_white-widow", rewardMin = 5, rewardMax = 6, item = 'weed_white-widow', label = 'White Widow 2g'},
    {type = "weed_skunk", rewardMin = 4, rewardMax = 6, item = 'weed_skunk', label = 'Skunk 2g'},
    {type = "weed_purple-haze", rewardMin = 3, rewardMax = 5, item = 'weed_purple-haze', label = 'Purple Haze 2g'},
    {type = "weed_og-kush", rewardMin = 2, rewardMax = 3, item = 'weed_og-kush', label = 'OGKush 2g'},
	{type = "weed_amnesia", rewardMin = 2, rewardMax = 3, item = 'weed_amnesia', label = 'Amnesia 2g'},
	{type = "weed_ak47", rewardMin = 2, rewardMax = 3, item = 'weed_ak47', label = 'AK47 2g'},
}
